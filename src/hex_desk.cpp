...
const hex_describer_t described_hexes_desk[] = {
		...
		{.id = 7, .offset_percentage = 0, .invert_order = false, .borders = {1, 8, -1, -1, -1, 18}, .leds = {0, 1, 2, 3, 4, 5, 6, 7, 8, 471, 472, 473, 474, 475, 476, 477, 478, 479, 480, 481, 482, 483, 484, 485, 486, 487, 488, 489, -1}},
		...
		{.id = 18, .offset_percentage = 0, .invert_order = true, .borders = {6, 1, 7, -1, -1, 17}, .leds = {229, 228, 227, 226, 225, 224, 223, 222, 221, 248, 247, 246, 245, 244, 243, 242, 241, 240, 239, 238, 237, 236, 235, 234, 233, 232, 231, 23, -1}}};
